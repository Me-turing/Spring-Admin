...
public class DbKeyCacheUtil {
     ...
     * 配置缓存
     */
    private final Cache<String, DbKey> configCache;

    /**
     * ID缓存
     */
    private final Cache<String, List<String>> idCache;

    public DbKeyCacheUtil() {
        // 配置缓存
     ...
     * 获取配置缓存
     */
    public DbKey get(String tableName) {
     ...
     * 设置配置缓存
     */
    public void put(String tableName, DbKey dbKey) {
     ...
     * 设置ID缓存
     */
    public void putIds(String tableName, List<String> ids) {
     ...
     * 删除ID缓存
     */
    public void removeIds(String tableName) {
     ...
     * 获取配置缓存统计信息
     */
    public String configCacheStats() {
