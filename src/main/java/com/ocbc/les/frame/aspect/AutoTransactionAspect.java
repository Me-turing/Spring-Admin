package com.ocbc.les.frame.aspect;

import com.ocbc.les.common.annotation.transaction.AutoTransaction;
import com.ocbc.les.common.annotation.transaction.TransactionType;
import com.ocbc.les.common.config.transaction.TransactionPrefixConfig;
...
public class AutoTransactionAspect {
     ...
     */
    @Pointcut("@annotation(com.ocbc.les.common.annotation.transaction.AutoTransaction)")
