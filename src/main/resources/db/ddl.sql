...
-- 添加表注释
EXEC sp_addextendedproperty N'MS_Description', N'菜单角色关联表', N'SCHEMA', N'dbo', N'TABLE', N'menu_role';

-- 添加列注释
EXEC sp_addextendedproperty N'MS_Description', N'菜单ID', N'SCHEMA', N'dbo', N'TABLE', N'menu_role', N'COLUMN', N'menu_id';
EXEC sp_addextendedproperty N'MS_Description', N'角色ID', N'SCHEMA', N'dbo', N'TABLE', N'menu_role', N'COLUMN', N'role_id';
EXEC sp_addextendedproperty N'MS_Description', N'状态（0：正常，1：停用）', N'SCHEMA', N'dbo', N'TABLE', N'menu_role', N'COLUMN', N'status';
EXEC sp_addextendedproperty N'MS_Description', N'删除标志（0：存在，1：删除）', N'SCHEMA', N'dbo', N'TABLE', N'menu_role', N'COLUMN', N'del_flag';
EXEC sp_addextendedproperty N'MS_Description', N'创建者', N'SCHEMA', N'dbo', N'TABLE', N'menu_role', N'COLUMN', N'create_by';
EXEC sp_addextendedproperty N'MS_Description', N'创建者机构ID', N'SCHEMA', N'dbo', N'TABLE', N'menu_role', N'COLUMN', N'create_org_id';
EXEC sp_addextendedproperty N'MS_Description', N'创建时间', N'SCHEMA', N'dbo', N'TABLE', N'menu_role', N'COLUMN', N'create_time';
EXEC sp_addextendedproperty N'MS_Description', N'更新者', N'SCHEMA', N'dbo', N'TABLE', N'menu_role', N'COLUMN', N'update_by';
EXEC sp_addextendedproperty N'MS_Description', N'更新者机构ID', N'SCHEMA', N'dbo', N'TABLE', N'menu_role', N'COLUMN', N'update_org_id';
EXEC sp_addextendedproperty N'MS_Description', N'更新时间', N'SCHEMA', N'dbo', N'TABLE', N'menu_role', N'COLUMN', N'update_time';
EXEC sp_addextendedproperty N'MS_Description', N'备注', N'SCHEMA', N'dbo', N'TABLE', N'menu_role', N'COLUMN', N'remark';
